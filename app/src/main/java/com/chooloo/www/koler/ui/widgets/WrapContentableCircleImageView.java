...
public class WrapContentableCircleImageView extends AppCompatImageView {
    ...
    WrapContentableCircleImageView(Context context, int color) {
        ...
        if (elevationSupported()) {
            ...
            OvalShape oval = new WrapContentableCircleImageView.OvalShadow(mShadowRadius);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = WrapContentableCircleImageView.this.getWidth();
            final int viewHeight = WrapContentableCircleImageView.this.getHeight();
